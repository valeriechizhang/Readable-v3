...
app.put('/posts/:id', bodyParser.json(), (req, res) => {
    posts.edit(req.token, req.params.id, req.query)
      .then(
        (data) => res.send(data),
          (error) => {
              console.error(error)
...
app.put('/comments/:id', bodyParser.json(), (req, res) => {
    comments.edit(req.token, req.params.id, req.query)
      .then(
        (data) => res.send(data),
          (error) => {
              console.error(error)
...
app.post('/comments', bodyParser.json(), (req, res) => {
    comments.add(req.token, req.query)
      .then(
          (data) => res.send(data),
          (error) => {
              console.error(error)
